...
<div class="on" onclick="window.location.href='history.php'"><strong>OOC查询</strong></div>
	...
	switch($chartType){
		...
		case TYPE_XS:				
			foreach($details as $point){
				...
				echo "<td><a href='../chart/accessChart.php?chartId=".$chartId."&pointId=".$point['id']."'><img src='../img/little_chart2.gif' border=0/></a></td>";
